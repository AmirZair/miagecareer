          ...
          <form name="sentMessage" id="contactForm" novalidate action="<?=site_url('contact/contacter');?>" method="post">
            ...
            <div class="control-group">
              <div class="form-group floating-label-form-group controls">
                <label>Message</label>
                <textarea rows="5"  name="message" class="form-control" placeholder="Message" id="message" required data-validation-required-message="Veuillez introduire votre message."></textarea>
                <p class="help-block text-danger"></p>
              </div>
            </div>
            <br>
