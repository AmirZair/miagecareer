...
<div class="container-fluid no-padding" style="max-width: calc(100vw - 250px); width: calc(100vw - 250px); overflow: hidden; /*border: 1px solid red;*/">
    <h1 style="text-align: center; font-family: 'Comic Sans MS';">Liste des Entrerpise</h1>
    <div style="margin-top: 20px;">
        <table id="mytable" class="table table-bordered table-striped table-hover table-condensedk">
            ...
            foreach ($entreprise as $e) {
                ...
                echo '<td>'.$e['ville'].'</td>';
                echo '<td>'.$e['secteur'].' Mois'.'</td>';
                echo '<td>'.$e['adresse'].'</td>';
                echo '<td style="text-align: center;"><a id="" class="update-offre"><span class="glyphicon glyphicon-edit"></span></a></td>';
                echo '</tr>';
            }
            ?>
            </tbody>
    ...
    <button id="add_offre" class="btn btn-primary form-control" style="margin-top: 50px;">Ajouter une entreprise</button>
</div>
