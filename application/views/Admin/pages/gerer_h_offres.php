<?php include('Modals/offre_modal_update_h.php') ?>
<?php include('Modals/offre_modal_add_h.php') ?>
...
<div class="container-fluid no-padding" style="max-width: calc(100vw - 250px); width: calc(100vw - 250px); overflow: hidden; /*border: 1px solid red;*/">
    <h1 style="text-align: center; font-family: 'Comic Sans MS';">Liste des offres de stage en historique</h1>
        ...
        <table id="mytable" class="table table-bordered table-striped table-hover table-condensedk">
            ...
            foreach ($offres_h as $offre) {
                ...
                echo '<td style="text-align: center;">
										<a href="../admin/delete_offre_h/'.$offre['id'].'" Onclick="return ConfirmDelete();"><span style="color:red;" class="glyphicon glyphicon-trash"></span></a>
									</td>';
                echo '</tr>';
            }
            ?>
